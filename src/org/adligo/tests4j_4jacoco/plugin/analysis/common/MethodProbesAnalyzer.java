...
public class MethodProbesAnalyzer extends MethodProbesVisitor {
	 ...
	 */
	public MethodProbesAnalyzer(final String name, final String desc,
			final String signature, final I_Probes probes) {
		super();
		this.probes = probes;
	...
	private void addProbe(final int probeId) {
		lastInsn.addBranch();
		if (probes != null && probes.get(probeId)) {
