...
public class BooleanArrayInterfaceTypeStrategy extends AbstractObtainProbesStrategy implements I_ObtainProbesStrategy {
	
	public BooleanArrayInterfaceTypeStrategy(I_ClassInstrumentationInfo pClassInfo,
