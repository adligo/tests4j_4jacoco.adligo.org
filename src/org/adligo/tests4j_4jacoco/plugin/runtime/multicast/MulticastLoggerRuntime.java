...
import org.adligo.tests4j_4jacoco.plugin.instrumentation.JacocoInstrConstants;
 ...
 * the parameter array.
 */
public class MulticastLoggerRuntime extends AbstractMulticastRuntime {
	...
	public int generateDataAccessor(final long classid, final String classname,
		...
		ClassCoverageDataParamFactory fetcher = new ClassCoverageDataParamFactory(mv);
		fetcher.create(classid, classname, probecount);
		...
		mv.visitTypeInsn(Opcodes.CHECKCAST, JacocoInstrConstants.DATAFIELD_DESC);
